...
/**
 * n8n Webhook Integration - Production Build
 * Verified Production URLs
 */

const SIGNUP_WEBHOOK_URL = 'https://n8n.srv1106977.hstgr.cloud/webhook/815e20d7-39c1-485f-ac81-cbf14dc757b3';
const LOGIN_CHECK_WEBHOOK_URL = 'https://n8n.srv1106977.hstgr.cloud/webhook/4f70ab27-7453-424e-af21-3f1b85b992c1';
const MAINCORE_WEBHOOK_URL = 'https://n8n.srv1106977.hstgr.cloud/webhook/07b05952-fd19-4f31-b20a-97a71551d11a';
...
export const triggerN8nWorkflow = async (data: any, action: string, customUrl?: string) => {
  ...
  try {
    ...
    if (!response.ok) {
        ...
        console.error(`[n8n Production Error ${response.status}]`, errorText);
    ...
    if (error.message === 'Failed to fetch') {
      throw new Error("Network Error: Could not connect to n8n production server. Please ensure the project is active.");
    }
    throw error;
  }
};
